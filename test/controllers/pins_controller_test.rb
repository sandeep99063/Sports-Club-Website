...
class PinsControllerTest < ActionController::TestCase
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post :create, pin: { email: @pin.email, name: @pin.name, refer: @pin.refer, remark: @pin.remark }
    end
  ...
  test "should update pin" do
    patch :update, id: @pin, pin: { email: @pin.email, name: @pin.name, refer: @pin.refer, remark: @pin.remark }
    assert_redirected_to pin_path(assigns(:pin))
  end
